...
int main()
{
  ...
  while (r.ReadData(v))
  {
    if (std::holds_alternative<mrd::Acquisition>(v))
    {
      ...
      if ((a.flags & static_cast<uint64_t>(mrd::AcquisitionFlags::kFirstInEncodeStep1)) || (a.flags & static_cast<uint64_t>(mrd::AcquisitionFlags::kFirstInSlice)))
      {
      ...
      if ((a.flags & static_cast<uint64_t>(mrd::AcquisitionFlags::kLastInEncodeStep1)) || (a.flags & static_cast<uint64_t>(mrd::AcquisitionFlags::kLastInSlice)))
      {
